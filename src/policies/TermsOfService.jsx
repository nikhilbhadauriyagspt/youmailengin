      ...
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="space-y-12 text-zinc-600 leading-relaxed text-[15px]">
          <section className="space-y-6">
            <h2 className="text-xl font-black text-zinc-900 uppercase tracking-tight">AGREEMENT TO OUR LEGAL TERMS</h2>
            <p>
              We are <strong>All About Drivers</strong> ("Company," "we," "us," or "our"), a company registered in china, 130 S Fillmore St, Corinth, MS 38834, United States.
            </p>
            <p>
              We operate the website <a href="http://allaboutdrivers.shop/" className="text-blue-600 font-bold hover:underline">http://allaboutdrivers.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
            </p>
            <p>
              All About Drivers was founded on the principle that household repairs should be handled with the same level of precision as industrial maintenance. We recognize that modern appliances are complex electronic systems that require specialized knowledge and calibrated tools for effective servicing.
            </p>
            <p>
              You can contact us by email at <a href="mailto:info@allaboutdrivers.shop" className="text-blue-600 font-bold">info@allaboutdrivers.shop</a>, or by mail to 130 S Fillmore St, Corinth, MS 38834, United States.
            </p>
            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and All About Drivers, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            </p>
            <p>
          ...
          <section className="bg-zinc-50 p-8 md:p-12 rounded-[2.5rem] border border-zinc-100">
            <h2 className="text-xl font-black text-zinc-900 uppercase mb-8 tracking-tight">TABLE OF CONTENTS</h2>
          ...
          <div className="space-y-16">
            <section id="1" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">1. OUR SERVICES</h3>
            ...
            <section id="2" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">2. INTELLECTUAL PROPERTY RIGHTS</h3>
              ...
              <p>Except as set out in this section or elsewhere in our Legal Terms, no part of the Services and no Content or Marks may be copied, reproduced, aggregated, republished, uploaded, posted, publicly displayed, encoded, translated, transmitted, distributed, sold, licensed, or otherwise exploited for any commercial purpose whatsoever, without our express prior written permission. If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: info@allaboutdrivers.shop. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
            ...
            <section id="3" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">3. USER REPRESENTATIONS</h3>
            ...
            <section id="4" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">4. PROHIBITED ACTIVITIES</h3>
            ...
            <section id="5" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">5. USER GENERATED CONTRIBUTIONS</h3>
            ...
            <section id="6" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">6. CONTRIBUTION LICENSE</h3>
            ...
            <section id="7" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">7. SERVICES MANAGEMENT</h3>
            ...
            <section id="8" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">8. PRIVACY POLICY</h3>
              <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://allaboutdrivers.shop/privacy-policy" className="text-blue-600 font-bold">http://allaboutdrivers.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Services, you are transferring your data to the United States, and you expressly consent to have your data transferred to and processed in the United States.</p>
            </section>

            <section id="9" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">9. TERM AND TERMINATION</h3>
            ...
            <section id="10" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">10. MODIFICATIONS AND INTERRUPTIONS</h3>
            ...
            <section id="11" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">11. GOVERNING LAW</h3>
            ...
            <section id="12" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">12. DISPUTE RESOLUTION</h3>
            ...
            <section id="13" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">13. CORRECTIONS</h3>
              <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
            </section>

            <section id="14" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">14. DISCLAIMER</h3>
            ...
            <section id="15" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">15. LIMITATIONS OF LIABILITY</h3>
            ...
            <section id="16" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">16. INDEMNIFICATION</h3>
            ...
            <section id="17" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">17. USER DATA</h3>
            ...
            <section id="18" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">18. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
            ...
            <section id="19" className="space-y-6">
              <h3 className="text-xl font-black text-zinc-900 uppercase tracking-tight border-b border-zinc-100 pb-4">19. MISCELLANEOUS</h3>
            ...
            <section id="21" className="p-10 bg-zinc-900 rounded-[2.5rem] text-white">
              <h3 className="text-xl font-black uppercase mb-6 tracking-tight">21. CONTACT US</h3>
