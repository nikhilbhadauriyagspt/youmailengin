      ...
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <div className="prose prose-zinc max-w-none text-[16px] leading-relaxed text-zinc-700 space-y-10">
          <section className="space-y-4">
            ...
            <p>We are <strong>Mail Yaga</strong> ("Company," "we," "us," "our"),</p>
            <p>
              We operate the website <a href="http://mailyaga.shop/" className="text-blue-800 underline">http://mailyaga.shop/</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").
            </p>
            <p>
              Mail Yaga was founded on the principle that household repairs should be handled with the same level of precision as industrial maintenance. We recognize that modern appliances are complex electronic systems that require specialized knowledge and calibrated tools for effective servicing.
            </p>
            <p>You can contact us by email at <span className="text-blue-800 font-medium">info@mailyaga.shop</span></p>
            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Mail Yaga, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</strong>
            </p>
            <p>
          ...
          <section className="space-y-12 pt-10">
            ...
            <div className="space-y-4">
              ...
              <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: info@mailyaga.shop.</p>
            ...
            <div className="space-y-4">
              ...
              <p>We care about data privacy and security. Please review our Privacy Policy: <a href="http://mailyaga.shop/privacy-policy" className="text-blue-800 underline">http://mailyaga.shop/privacy-policy</a>. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms.</p>
            </div>
