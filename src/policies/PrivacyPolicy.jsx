    ...
    <section className="py-24 bg-white font-sans text-zinc-900 min-h-screen">
      ...
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <div className="prose prose-zinc max-w-none text-[16px] leading-relaxed text-zinc-700 space-y-8">
          ...
          <p>
            Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <span className="text-blue-800 font-medium">info@youmailengine.com</span>.
          </p>

          <div className="bg-zinc-50 p-8 rounded-3xl border border-zinc-100 space-y-6">
            <h2 className="text-xl font-bold text-zinc-900 uppercase tracking-wider border-b border-zinc-200 pb-4">SUMMARY OF KEY POINTS</h2>
            <p className="italic text-sm mb-4 text-zinc-600 underline">This summary provides key points from our Privacy Notice, but you can find out more details about any of these topics by clicking the link following each key point or by using our table of contents below to find the section you are looking for.</p>
          ...
          <div className="space-y-4">
            ...
            <ol className="list-decimal pl-6 space-y-1 text-blue-800 font-medium text-sm">
          ...
          <div className="space-y-10 pt-10">
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">1. WHAT INFORMATION DO WE COLLECT?</h2>
              <h3 className="text-lg font-bold text-zinc-800 underline decoration-blue-800/30">Personal information you disclose to us</h3>
              ...
              <h3 className="text-lg font-bold text-zinc-800 underline decoration-blue-800/30 mt-8">Information automatically collected</h3>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">3. WHAT LEGAL BASES DO WE RELY ON TO PROCESS YOUR PERSONAL INFORMATION?</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
              ...
              <p>We also permit third parties and service providers to use online tracking technologies on our Services for analytics and advertising. This includes Google Analytics.</p>
              <p><strong>Google Analytics:</strong> We may share your information with Google Analytics to track and analyze the use of the Services. To opt out of being tracked by Google Analytics across the Services, visit <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-800 underline">https://tools.google.com/dlpage/gaoptout</a>.</p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">6. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">7. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">8. DO WE COLLECT INFORMATION FROM MINORS?</h2>
            ...
            <section className="space-y-4">
              ...
              <p>In some regions (like Canada), you have certain rights under applicable data protection laws. These may include the right (i) to request access and obtain a copy of your personal information, (ii) to request rectification or erasure; (iii) to restrict the processing of your personal information; and (iv) if applicable, to data portability. You can make such a request by contacting us at <span className="text-blue-800 font-medium">info@youmailengine.com</span>.</p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
            ...
            <section className="space-y-4">
              ...
              <p>To exercise your rights, you can contact us by emailing us at <span className="text-blue-800 font-medium">info@youmailengine.com</span>.</p>
            </section>

            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">12. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl font-bold text-zinc-900">14. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
              <p>Based on the applicable laws of your country or state of residence in the US, you may have the right to request access to the personal information we collect from you, details about how we have processed it, correct inaccuracies, or delete your personal information. To request to review, update, or delete your personal information, please contact us.</p>
            </section>
          </div>
        </div>
      </div>
