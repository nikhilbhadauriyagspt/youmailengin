    ...
    <section className="py-24 bg-white font-sans text-zinc-900 min-h-screen">
      <div className="max-w-[1000px] mx-auto px-6">
        ...
        <div className="space-y-12 text-[17px] leading-relaxed text-zinc-700">
          <p>
            This Cookie Policy explains how Mail Yaga (“Company,” “we,” “us,” or “our”) uses cookies and similar tracking technologies when you visit our website <a href="http://mailyaga.shop/" className="text-blue-800 underline">http://mailyaga.shop/</a> (the “Website”). This policy should be read together with our <strong>PRIVACY POLICY</strong> and <strong>TERMS OF SERVICE</strong>.
          </p>
          ...
          <div className="space-y-4">
            ...
            <p>Some browsers offer a “Do Not Track” (DNT) feature. At this time, there is no uniform industry standard for recognizing DNT signals, and Mail Yaga does not currently respond to such signals <strong>PRIVACY POLICY</strong>.</p>
          </div>
