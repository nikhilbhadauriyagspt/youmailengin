      ...
      <div className="max-w-[1800px] mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 lg:gap-12 mb-20">
          ...
          <div className="lg:col-span-5 space-y-8">
            <Link to="/" className="inline-block">
              <img src="/logo.avif" alt="Yagamail logo" className="h-12 w-auto object-contain" />
            </Link>
            <p className="text-[17px] leading-relaxed font-normal text-zinc-600 max-w-md">
              Your reliable resource for mastering everyday email communication. We provide detailed guides and tutorials to help you optimize your digital workflow.
            </p>
          ...
          <div className="lg:col-span-4 lg:pl-10">
            ...
            <div className="space-y-8">
              <p className="text-[16px] text-zinc-600 leading-relaxed">Looking for something specific? Our knowledge base is designed to help you find answers fast.</p>
              
              <div className="space-y-5">
                <a href="mailto:info@yagamail.shop" className="flex items-center gap-5 p-5 rounded-3xl bg-zinc-50 border border-zinc-100 hover:border-blue-200 hover:bg-white hover:shadow-xl transition-all group">
                  ...
                  <div>
                    ...
                    <p className="text-zinc-900 font-bold text-[16px]">info@yagamail.shop</p>
                  </div>
                </a>
        ...
        <div className="mt-12 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-zinc-600 text-[13px] font-medium">
            © {currentYear} Yagamail. All rights reserved.
          </p>
