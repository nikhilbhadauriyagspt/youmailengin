...
export const guidesData = [
  {
    ...
    solution: 'First, check your internet connection and the size of any attachments (most providers limit this to 25MB). Next, verify your SMTP (outgoing server) settings. Often, simply removing the stuck email from the Outbox and re-composing it fixes temporary glitches. We can help you re-authenticate your server settings if the problem persists.',
  ...
  },
  {
    ...
    solution: 'Check your "Spam" or "Junk" folders first. Ensure your mailbox storage isn’t full, as a full mailbox blocks all incoming mail. Verify your IMAP/POP settings—if these are wrong, your app can’t "pull" new mail from the server. We can walk you through a settings audit to find exactly where the delivery is breaking.',
  ...
  },
  {
    ...
    solution: 'This is almost always due to using "POP3" instead of "IMAP" protocol. IMAP is designed to sync actions across all devices, while POP3 is not. We can help you switch your account to IMAP settings without losing your existing emails, ensuring a perfect "Mirror" effect on every device you own.',
  ...
  },
  {
    ...
    solution: 'You need to "Whitelist" important senders by adding them to your Safe Senders list. Conversely, use the "Block" feature for persistent spam. We can help you adjust your filter sensitivity settings so the automated systems learn what you actually want to see.',
  ...
  },
  {
    ...
    solution: 'Check if the file type is "executable" (like .exe), as these are often blocked. For large files, use a cloud link (like Google Drive or OneDrive) instead of attaching the file directly. If downloads are failing, it might be an antivirus setting on your computer. We can help you adjust these safely.',
  ...
  },
  {
    ...
    solution: 'Search for emails with large attachments (e.g., "size:10mb") and delete those you no longer need. Empty your "Deleted Items" and "Junk" folders, as these still count toward your limit. We can help you set up an "Auto-Archive" system that moves old mail to your local computer to keep your cloud storage free.',
  ...
  },
  {
    ...
    solution: 'You will need to verify your identity using a code sent to your phone or backup email. If you don’t have those, you’ll need to fill out a detailed account recovery form. We can help you gather the information needed to pass these security checks and prove you are the rightful owner.',
  ...
  },
  {
    ...
    solution: 'Check the official status page for your provider (e.g., Google Workspace Status or Microsoft 365 Status). If there’s no global outage, the problem is likely your local server address (IMAP/SMTP URL). We can help you re-enter the correct server addresses to restore your connection immediately.',
